    ...
    return (
        <div style={{ display: "flex", height: "552px", border: "none", backgroundColor: "#282C4B" }}>
            ...
            <div style={{ border: "none", marginLeft: "189px", width: "459px" }}>
                ...
                <h4 style={{
                    color: "#F17216", height: "18px", fontWeight: "400", fontSize: "14px", lineHeight: "18px"
                }}>WHY CHOOSE US</h4>

                <h1 style={{
                    width: "495px", height: "120px", fontWeight: "700", fontSize: "36px", color: "#FFFFFF", lineHeight: "60px"
                }}>
